ÖRNEK; kod ile php dosyası oluşturma ve içerisine yazma.
<?php
$dosya = '<?php ';
$dosya .= '$isim = "Tarık"; ';
$dosya .= 'echo $isim; ';
...
file_put_contents('deneme.php', $dosya); //deneme.php şuan oluşacak ve içerisine $dosyada olan yazıları yazacak.
?>
...
$zaman = time() - 3600;        3600 saniye cinsinden yazılan bi değer.
...
fopen bir dosyayı açmamıza olanak tanır,
ilk parametre açılacak dosya ikinci paramerte ise ne amaçla açtığımızı bildiren kipi içerir.
...
Dosyanın içeriği tamamen silinir ve baştan itibaren yazmaya başlanır. Dosya belirtilen adreste yok ise yeniden oluşturulur.
...
Dosyanın içeriği silinmez, içeriğin sonuna veri eklenir. Dosya belirtilen adreste bulunmuyorsa yeniden oluşturulur.
a+ : Dosyaya hem veri eklenebilmesini hem de verinin okunabilmesinin gerektiğini belirtir.
Dosyanın içeriği silinmez, içeriğin sonuna veri eklenir. Dosya belirtilen adreste yok ise yeniden oluşturulur.
...
test.txt dosyasını okunmak ve içerisine veri yazmak için fopen fonksiyonu ile açıyoruz ve
dosyayı belirten değer $file değişkenine aktarılıyor.
