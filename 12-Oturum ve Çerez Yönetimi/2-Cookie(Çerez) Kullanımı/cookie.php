...
Bir değer verilmez ise tarayıcı kapandığında cookie silinir, tarayıcı açık kaldığı süre içerisinde aktif olur.
Zaman değeri, şu anki zaman + aktif olacağı süre şeklinde verilebilir. (örnek: time() + 60 //60 saniye aktif oldu)
...
//Dizi Depolama
setcookie("isim", 'Tarik', time() + 60); //yani bu cookie 60saniye boyunca geçerli olacak. sonra yok olacak.
setcookie("soyisim", 'Kahveci', time() + 60);
setcookie("email", 'tarikahveci@gmail.com', time() + 60);
